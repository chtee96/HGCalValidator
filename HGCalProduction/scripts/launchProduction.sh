...
then
  ...
  do
      echo "----- $i ------"
      echo python production_withdeltas.py --datTier RECO --evtsperjob 100 --queue tomorrow --partID 22 --nPart 1 --eosArea /eos/cms/store/group/dpg_hgcal/comm_hgcal/apsallid/CalibrationStudies --gunMode closeby --date ${thedate} --tag $i
      python production_withdeltas.py --datTier RECO --evtsperjob 100 --queue tomorrow --partID 22 --nPart 1 --eosArea /eos/cms/store/group/dpg_hgcal/comm_hgcal/apsallid/CalibrationStudies --gunMode closeby --date ${thedate} --tag $i
  done
